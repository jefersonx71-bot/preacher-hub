...
export function getMockEntry(rawTerm: string): DictionaryEntry {
  const clean = rawTerm
    .toLowerCase()
    .trim()
    .normalize("NFD")
  ...
  const dict: Record<string, DictionaryEntry> = {
    sucote: {
      ...
      summary:
        "Localidade geográfica onde o povo de Israel fez sua primeira parada após sair da escravidão do Egito (Êxodo 12:37). É também o nome da grande festa bíblica (Festa dos Tabernáculos), onde a nação habitava em cabanas temporárias para celebrar a colheita e lembrar o cuidado divino.",
      references: ["Êxodo 12:37", "Levítico 23:42-43", "Gênesis 33:17", "Salmo 60:6"],
      study:
        "Peso Espiritual: Sucote representa o início do caminho da libertação e a dependência total da provisão do Senhor no deserto. Lembra ao pregador e à igreja que nossa habitação terrena é temporária, mas a proteção de Deus sobre as nossas vidas é permanente, provendo abrigo e descanso sob a Sua soberania.",
      connections: [
    ...
    abisai: {
      ...
      summary:
        "Sobrinho de Davi e filho de Zeruia, irmão de Joabe. Foi um dos generais mais leais, corajosos e impulsivos de Davi, distinguindo-se como um de seus três principais guerreiros no combate contra gigantes e exércitos inimigos.",
      references: ["2 Samuel 23:18", "1 Samuel 26:6-9", "2 Samuel 21:17", "2 Samuel 19:21"],
      study:
        "Peso Espiritual: Abisai representa a fidelidade incondicional combinada com o perigo do impulso carnal. Embora tenha salvado Davi em combate, ele frequentemente desejava matar os adversários (como Saul e Simei) à força física, ilustrando que nossa dedicação aos líderes e à obra de Deus deve ser submetida à misericórdia e à vontade divina.",
      connections: [
    ...
    davi: {
      ...
      summary:
        "O segundo rei de Israel, ungido por Samuel quando era pastor de ovelhas. Homem segundo o coração de Deus, compositor da maioria dos Salmos e herói da fé que derrotou Golias. Foi da linhagem de Davi que nasceu Jesus Cristo.",
      references: ["1 Samuel 16:13", "Salmo 23:1", "Atos 13:22", "2 Samuel 7:12-16"],
      study:
        "Peso Espiritual: Davi nos ensina sobre a força do arrependimento genuíno. Seu peso espiritual reside no fato de que 'ser segundo o coração de Deus' não significa não pecar, mas sim ter um coração maleável, sensível à correção do Espírito Santo e pronto para confessar e abandonar o pecado.",
      connections: [
    ...
    moises: {
      ...
      summary:
        "O grande libertador, legislador e profeta de Israel. Foi escolhido por Deus para guiar o povo para fora da escravidão do Egito, recebeu as Tábuas da Lei no Monte Sinai e conduziu o povo pelo deserto por 40 anos.",
      references: ["Êxodo 2:10", "Êxodo 3:2-4", "Deuteronômio 34:10", "Hebreus 11:24-27"],
      study:
        "Peso Espiritual: Moisés exemplifica a intimidade espiritual e a mansidão. Falando com o Senhor face a face, ele nos ensina que o poder de liderança espiritual vem da presença diária no monte de Deus, e que o caráter do líder é forjado no deserto.",
      connections: [
    ...
    graca: {
      ...
      summary:
        "A atitude benevolente de Deus de conceder perdão, salvação e reconciliação espiritual à humanidade sem que haja qualquer merecimento próprio. Revela-se perfeitamente na cruz de Jesus Cristo.",
      references: ["Efésios 2:8-9", "Romanos 5:20", "2 Coríntios 12:9", "Tito 2:11"],
      study:
        "Peso Espiritual: A graça liberta o homem do peso do legalismo e da condenação. Ela nos ensina que somos amados pelo que Cristo realizou na cruz e que a graça não é apenas o perdão inicial, mas o poder diário que nos capacita a viver em santidade.",
      connections: [
    ...
    fe: {
      ...
      summary:
        "A confiança plena no caráter, na Palavra e nas promessas de Deus, mesmo quando as circunstâncias externas e físicas parecem contrárias. É o meio pelo qual tomamos posse da salvação.",
      references: ["Hebreus 11:1", "Romanos 10:17", "Gálatas 2:20", "Efésios 6:16"],
      study:
        "Peso Espiritual: O peso da fé está na nossa tomada de ação sob a Palavra de Deus. Ela nos move a marchar em obediência mesmo diante do mar fechado, transformando a esperança invisível em substância real na nossa vida cotidiana.",
      connections: [
    ...
    hebrom: {
      ...
      summary:
        "Uma das cidades mais antigas da Bíblia. Lugar onde Abraão ergueu altares e onde os patriarcas foram enterrados na caverna de Macpela. Serviu como a primeira capital do rei Davi por sete anos e meio.",
      references: ["Gênesis 13:18", "2 Samuel 2:1-4", "Josué 14:13-14", "Gênesis 23:19"],
      study:
        "Peso Espiritual: Hebrom simboliza a consolidação das alianças divinas e o amadurecimento espiritual. É o lugar onde a fidelidade acumulada do passado encontra a coroação e o início de um novo governo estabelecido por Deus.",
      connections: [
    ...
    elias: {
      ...
      summary:
        "Profeta corajoso do Antigo Testamento que confrontou o rei Acabe e a idolatria de Baal em Israel. Orou para parar a chuva, desafiou os profetas no Monte Carmelo e foi levado aos céus em um redemoinho com uma carruagem de fogo.",
      references: ["1 Reis 18:21", "1 Reis 19:11-12", "Tiago 5:17-18", "2 Reis 2:11"],
      study:
        "Peso Espiritual: Elias nos mostra que até mesmo os maiores homens de fé enfrentam dias de desânimo na caverna. O seu peso espiritual nos ensina que o sussurro manso e suave de Deus é o que restaura a nossa alma e nos envia de volta ao ministério.",
      connections: [
    ...
    pedro: {
      term: "Pedro",
      meaning:
        "Significado: 'Pedra' ou 'Pedregulho' (do grego Petros, tradução do aramaico Cefas).",
      summary:
        "Um dos principais apóstolos de Jesus Cristo, líder da igreja primitiva em Jerusalém e autor de duas epístolas. Anteriormente um pescador chamado Simão, foi transformado por Cristo em um pilar da fé cristã.",
      references: ["Mateus 16:18", "João 21:15-17", "Atos 2:14", "1 Pedro 1:1"],
      study:
        "Peso Espiritual: Pedro ilustra a jornada de restauração de caráter. Apesar de seu temperamento impulsivo e de ter negado a Jesus, a graça o restaurou para ser o pregador do Pentecostes, mostrando que nossas falhas não determinam o nosso destino quando estamos sob o amor redentor de Cristo.",
      connections: [
    ...
    paulo: {
      term: "Paulo",
      meaning:
        "Significado: 'Pequeno' ou 'Humilde' (do latim Paulus). Anteriormente Saulo ('Desejado').",
      summary:
        "O grande apóstolo dos gentios, autor de treze epístolas do Novo Testamento. Converteu-se no caminho de Damasco após perseguir ativamente a igreja primitiva, tornando-se o maior missionário da história do cristianismo.",
      references: ["Atos 9:3-6", "Romanos 1:1", "Gálatas 2:20", "2 Timóteo 4:7-8"],
      study:
        "Peso Espiritual: Paulo nos ensina a centralidade da cruz e a dependência da força divina na nossa fraqueza. Seu 'espinho na carne' exemplifica que as maiores tribulações e limitações humanas cooperam para que o poder e a glória de Deus se manifestem perfeitamente.",
      connections: [
    ...
    lutas: {
      ...
      meaning:
        "Significado: 'Lutas, tribulações e aflições temporárias' (do grego Thlipsis / hebraico Tsar).",
      summary:
        "O processo de provações e aflições pelas quais passamos. No contexto bíblico geral, as lutas não indicam o abandono de Deus, mas constituem a Sua oficina soberana para lapidar o nosso caráter e purificar a nossa confiança.",
      references: ["Tiago 1:2-4", "João 16:33", "Romanos 5:3-4", "1 Pedro 1:6-7"],
      study:
        "Peso Espiritual: O peso espiritual das lutas e tribulações é nos ensinar que o sofrimento produz perseverança, paciência e caráter aprovado. Ao sermos espremidos pela aflição, o orgulho é quebrado e o poder de Deus é aperfeiçoado em nós.",
      connections: [
    ...
    "mar vermelho": {
      ...
      summary:
        "O local histórico da libertação física de Israel da escravidão egípcia. Diante do exército de Faraó e do mar intransponível, Deus ordenou que o povo marchasse e abriu as águas por meio de Moisés, permitindo a travessia a pé enxuto (Êxodo 14).",
      references: ["Êxodo 14:21-22", "Salmo 106:9", "Hebreus 11:29", "1 Coríntios 10:1-2"],
      study:
        "Peso Espiritual: O Mar Vermelho representa a tribulação que parece nos encurralar sem saída. Para nós é um desespero, mas para Deus é o cenário perfeito para aperfeiçoar o nosso caráter e demonstrar que a salvação vem unicamente do Senhor. A instrução é: 'Não temais; aquietai-vos e vede o livramento'.",
      connections: [
    ...
    golias: {
      ...
      summary:
        "O guerreiro gigante da cidade filisteia de Gate que desafiou o exército de Israel por 40 dias. Foi derrotado pelo jovem pastor Davi usando apenas uma funda e uma pedra, demonstrando que a batalha pertence ao Senhor (1 Samuel 17).",
      references: ["1 Samuel 17:4", "1 Samuel 17:45-47", "2 Samuel 21:19", "1 Crônicas 20:5"],
      study:
        "Peso Espiritual: Golias representa as tribulações gigantescas e intimidadoras que vêm para paralisar a nossa caminhada com medo. No entanto, o gigante é o instrumento de Deus para tirar o Seu servo do anonimato e forjar um caráter de autoridade espiritual e confiança absoluta.",
      connections: [
    ...
    deserto: {
      ...
      summary:
        "O cenário geográfico e espiritual onde o povo de Israel peregrinou por 40 anos para ser testado e instruído na Lei de Deus. Foi também o local onde Jesus jejuou por 40 dias e foi tentado, vencendo o diabo com a Palavra.",
      references: ["Deuteronômio 8:2-3", "Mateus 4:1", "Oséias 2:14", "Lucas 1:80"],
      study:
        "Peso Espiritual: O deserto não é um lugar de abandono, mas a escola do Espírito. É na escassez de recursos humanos e no silêncio que Deus limpa o nosso caráter, ensina a dependência diária da Sua provisão (o maná) e fala diretamente ao nosso coração para nos preparar para a promessa.",
      connections: [
    ...
    "cova dos leoes": {
      ...
      summary:
        "O local de execução para onde o profeta Daniel foi lançado injustamente por manter seu hábito diário de oração ao Deus de Israel, desobedecendo ao decreto real. Deus enviou o Seu anjo e fechou a boca dos leões (Daniel 6).",
      references: ["Daniel 6:16", "Daniel 6:22", "Hebreus 11:33", "1 Pedro 5:8"],
      study:
        "Peso Espiritual: A cova dos leões nos ensina sobre a fidelidade inabalável sob perseguição. A tribulação extrema de ser lançado às feras é o palco onde Deus demonstra que a nossa integridade no secreto nos preserva no meio do perigo, aperfeiçoando a nossa perseverança.",
      connections: [
  ...
  return {
    term: rawTerm.charAt(0).toUpperCase() + rawTerm.slice(1).toLowerCase(),
    meaning: `Significado/Etimologia: Para ver a etimologia e significado exatos de "${rawTerm}", ative a chave de IA.`,
    summary: `O termo "${rawTerm}" desempenha um papel importante nas escrituras sagradas. No Antigo e Novo Testamento, conceitos e termos como este servem para nos revelar aspectos da santidade de Deus, do comportamento esperado do Seu povo e da revelação profética da redenção em Jesus Cristo.`,
    references: ["Salmo 119:105", "João 1:1", "2 Timóteo 3:16"],
    study: `Peso Espiritual: Use o termo "${rawTerm}" no seu sermão para ilustrar a soberania divina e chamar a igreja a uma decisão prática de obediência. Lembre a congregação de que a Palavra de Deus se aplica a cada detalhe das nossas vidas, nos desafiando a abandonar a autossuficiência e a depender totalmente da graça e da direção do Espírito Santo.`,
    connections: [
...
export const lookupTerm = createServerFn({ method: "POST" })
  ...
  .handler(async ({ data }): Promise<DictionaryEntry> => {
    ...
    if (!apiKey) {
      console.warn(
        "Nenhuma chave de API (GEMINI_API_KEY ou LOVABLE_API_KEY) configurada. Usando dados de preview simulados.",
      );
      return getMockEntry(data.term);
    }
    ...
    const modelName = isGeminiStudio ? "gemini-2.5-flash" : "google/gemini-3-flash-preview";
    ...
    try {
                ...
                parameters: {
                  ...
                  properties: {
                    ...
                    connections: {
                      ...
                      items: { type: "string" },
                      description:
                        "2 a 4 conexões ou paralelos de outras histórias bíblicas que compartilham o mesmo peso espiritual",
                    },
                  },
      ...
      console.warn(
        "Erro ao buscar termo na API do Gemini. Usando dados mockados como fallback offline:",
        err,
      );
      return getMockEntry(data.term);
    }
